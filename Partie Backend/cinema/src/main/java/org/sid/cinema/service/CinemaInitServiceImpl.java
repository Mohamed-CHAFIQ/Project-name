...
public class CinemaInitServiceImpl implements ICinemaInitService  {
	...
	public void initCategories() {
		Stream.of("Histoire","Actions","fiction","Dramma").forEach(cat->{
	...
	public void initFilms() {
		...
		Stream.of("12 Hommes en colère","Forrest Gump","Green Book","La Ligne Verte","Le Parrain","Le seigneur des anneaux").forEach(titreFilm->{
			Film film=new Film();
